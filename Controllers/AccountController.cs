namespace RadAppPro.Pwa.Controllers
{
    using AutoMapper;
    using DAL.Core;
    ...
    {
        #region I construct controller using:
        ...
        public async Task<IActionResult> DeleteUser(string id)
        {
            ...
            //Test for CanRemoveCustomer - Condition IsContractorContracted - Yes No
            //Test for CanRemoveContractorOfCustomer - Condition IsContractor - Fired, Fail, Success
            //Test for CanRemoveSubContractorOfContractor - Condition Is SubContractor - Contracted, NotContracted, Complete, OSHAViolation, Suspended, Other
            //Test for CanRemoveContractedEmployeeOfSubContractor - Condition Is Contracted - NotContracted, Injured, Certificate, Other
        ...
        private async Task SendVerificationEmail(ApplicationUser appUser)
        {
            ...
            string callbackUrl = $"{Request.Scheme}://{Request.Host}/ConfirmEmail?userId={appUser.Id}&code={code}";
