namespace RadAppPro.Pwa
{
    ...
    public class IdentityServerConfig
    {
        ...
        public const string ApiFriendlyName = "RadAppPro API";
        public const string RadAppProClientID = "radapp_spa";
        public const string SwaggerClientID = "swaggerui";
       
        //Identity rsrce for UserInfo endpoints
        ...
        public static IEnumerable<Client> GetClients()
        {
            ...
            return new List<Client>
            {
                ...
                new Client
                {
                    ClientId = IdentityServerConfig.RadAppProClientID,
